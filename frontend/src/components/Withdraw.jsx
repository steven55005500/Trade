...
export default function Withdraw({ user, onBack }) {
  ...
  return (
    <div style={{ backgroundColor: '#f8fafc', minHeight: '100vh', padding: '20px', fontFamily: 'Arial, sans-serif', color: '#333' }}>
      {/* Header */}
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
        <button onClick={onBack} style={{ border: 'none', background: 'none', fontSize: '24px', cursor: 'pointer', marginRight: '10px' }}>←</button>
      ...
      <div style={{ backgroundColor: '#fff', borderRadius: '15px', padding: '20px', textAlign: 'center', boxShadow: '0 2px 10px rgba(0,0,0,0.05)', marginBottom: '20px' }}>
        ...
        <button style={{ width: '100%', backgroundColor: '#0ea5e9', color: '#fff', border: 'none', padding: '12px', borderRadius: '10px', fontWeight: 'bold', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px' }}>
           🧊 Exchange to TP
        </button>
      </div>
